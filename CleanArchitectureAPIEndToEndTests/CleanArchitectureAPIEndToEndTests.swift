//
//  CleanArchitectureAPIEndToEndTests.swift
//  CleanArchitectureAPIEndToEndTests
//
//  Created by Faiyaz Ahmed on 21/08/2025.
//

import XCTest
import CleanArchitecture

final class CleanArchitectureAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedImageDataResult_matchesFixedTestAccountData() {
        switch getImageFeedDataResult() {
        case let .success(data)?:
            XCTAssertFalse(data.isEmpty, "Expected non-empty image set")
        case let .failure(error)?:
    ...
    private func getImageFeedDataResult(file: StaticString = #file, line: UInt = #line) -> FeedImageDataLoader.Result? {
