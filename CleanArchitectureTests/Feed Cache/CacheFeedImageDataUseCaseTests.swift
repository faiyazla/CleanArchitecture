...
public final class CacheFeedImageDataUseCaseTests: XCTestCase {
    ...
    func test_loadImageDataFromURL_requestsImageDataInsertionForURL() {
    ...
    func test_save_ImageDataFromURL_failsOnStoreInsertionError() {
        let (sut, store) = makeSUT()
