...
extension FeedStoreSpecs where Self: XCTestCase {
    func expect(_ sut: FeedStore, toRetrieve expectedResult: FeedStore.RetrievalResult, file: StaticString = #file, line: UInt = #line) {
        ...
        sut.retrieve { retrievedResult in
            ...
            case let (.success(.found(retrieveResultFeed, retrievedResultTimestamp)), .success(.found(expectedResultFeed, expectedResultTimestamp))):
    ...
    func expect(_ sut: FeedStore, toRetrieveTwice: FeedStore.RetrievalResult, file: StaticString = #file, line: UInt = #line) {
